...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'grinnygrant-4': dict(ref_gpus=4,  kimg=25000, mb=16, mbstd=4, fmaps=1, lrate=0.002, gamma=10, ema=10, ramp=None, map=8),
        'grinnygrant-8': dict(ref_gpus=8,  kimg=25000, mb=16, mbstd=4, fmaps=1, lrate=0.002, gamma=10, ema=10, ramp=None, map=8),
    }
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', '11gb-gpu','11gb-gpu-complex', '24gb-gpu','24gb-gpu-complex', '48gb-gpu','48gb-2gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline', 'aydao', 'grinnygrant-2', 'grinnygrant-4', 'grinnygrant-8']))
